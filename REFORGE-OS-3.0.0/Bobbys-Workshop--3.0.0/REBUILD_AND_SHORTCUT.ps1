# ============================================
# REBUILD AND CREATE SHORTCUT
# Rebuilds the app and creates "Bobby's Secret Rooms 1.0" desktop shortcut
# ============================================
...
$projectDir = Join-Path $currentDir "Bobbys-Workshop--3.0.0"
...
Write-Host "📦 Step 2/3: Preparing bundle..." -ForegroundColor Yellow
npm run prepare:bundle
if ($LASTEXITCODE -ne 0) { Write-Host "❌ Bundle preparation failed!" -ForegroundColor Red; exit 1 }
Write-Host "✅ Bundle preparation complete" -ForegroundColor Green
Write-Host ""

# Step 3: Build Tauri
Write-Host "📦 Step 3/3: Building Tauri application..." -ForegroundColor Yellow
...
try {
    ...
    if (Test-Path $shortcutPath) {
        ...
        Write-Host "   Logs: $env:LOCALAPPDATA\BobbysWorkshop\logs\" -ForegroundColor Gray
    }
...
Write-Host "═══════════════════════════════════════════════════════" -ForegroundColor Cyan
Write-Host ""
Write-Host "🎉 Desktop shortcut 'Bobby's Secret Rooms 1.0' is ready!" -ForegroundColor Green
Write-Host ""
